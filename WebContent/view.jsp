...
<div id="content">
	...
	<tr><th>ID</th><th>Name</th><th>Breed</th><th>Group</th><th>Gender</th><th>Owner Name</th><th>Dog Type</th></tr>
	<%
...
<tr>
	...
	<td><%=list.get(i).getSpeciality() %></td>
</tr>
<%	}
	%>
	</table><br><br>
...
<div id="footer">
     ...
     <a href="ShowList"><button id="generate">Generate ShowList</button></a>
    <table id="menu">
